...
def test_delete_user():
    ...
    response = requests.delete(f"{base_url}/delete_user/{test_user_name}", headers={"Authorization": f"Bearer {TOKEN}"})
    ...
    response = requests.delete(f"{base_url}/delete_user/test_user", headers={"Authorization": f"Bearer incorrect_token"})
